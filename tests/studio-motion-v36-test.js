...
const checks=[
 ...
 ['usa somente os clipes D-ID aprovados de Paulo',/\/assets\/v33-did\/01-paulo\.mp4[\s\S]*\/assets\/v33-did\/09-paulo\.mp4/],
 ['usa somente os clipes D-ID aprovados de Deijanete',/\/assets\/v33-did\/02-deijanete\.mp4[\s\S]*\/assets\/v33-did\/10-deijanete\.mp4/],
