...
const checks=[
 ...
 ['conversa usa os clipes D-ID alternados ja existentes',/assets\/v33-did\/01-paulo\.mp4[\s\S]*assets\/v33-did\/02-deijanete\.mp4[\s\S]*assets\/v33-did\/09-paulo\.mp4[\s\S]*assets\/v33-did\/10-deijanete\.mp4/],
 ['lip sync vem do video D-ID e fica acima da imagem mas abaixo dos efeitos',/\.vn-avatar-video\{[\s\S]*z-index:4!important/],
