...
const FIXED=['/','/anunciantes.html','/ibj.html','/materias/roney-nemer-11111.html','/energia/','/mobilidade/','/saude-beleza/','/moveis-decoracao/','/gastronomia/','/poder-justica-cidadania/','/economia-negocios-consumo/','/tecnologia-ia-midia/','/educacao-carreiras-cultura/','/estilo-esporte-experiencias/'];
