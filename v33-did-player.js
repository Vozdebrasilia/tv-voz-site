(() => {
  ...
  css.textContent = `
    ...
    #tv-ao-vivo .idle-avatar{overflow:hidden!important;isolation:isolate!important}
    #tv-ao-vivo .idle-avatar-body{opacity:1!important;transition:opacity .16s linear,transform .28s ease!important;will-change:transform,opacity!important}

    /* O MP4 deve ocupar exatamente a mesma moldura do apresentador. */
    ...
    /* No celular, mantém os dois apresentadores inteiros dentro da bancada. */
    @media(max-width:620px){
      #tv-ao-vivo .idle-deijanete{left:8%!important;top:25%!important;width:38%!important;height:50%!important}
      #tv-ao-vivo .idle-paulo{left:54%!important;top:25%!important;width:38%!important;height:50%!important}
      #tv-ao-vivo .v33-did-video{object-fit:contain!important;object-position:center bottom!important}
    }
  `;
