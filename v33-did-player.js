...
(()=>{
  function init(){
    ...
    studio.innerHTML=`
      <img class="vn-approved-image" src="/studio-terninho-final.webp?v=20260905-final" alt="Estúdio VOZ NEWS com Deijanete Fayad e Paulo Fayad" fetchpriority="high" decoding="async">
    ...
    style.textContent=`
#tv-ao-vivo{position:relative!important;aspect-ratio:1672/941!important;min-height:0!important;height:auto!important;overflow:hidden!important;border-radius:26px!important;background:#04142b!important;isolation:isolate!important;box-shadow:0 30px 80px rgba(0,0,0,.52),0 0 36px rgba(0,119,255,.20)!important}
...
@media(prefers-reduced-motion:reduce){.vn-market-runner{animation:vnMarket 18s linear infinite!important}.vn-hot-runner{animation:vnHot 36s linear infinite!important}}
...
`;
    ...
    if(imageLayer.complete&&imageLayer.naturalWidth){imageStatus.classList.add('ready');document.documentElement.dataset.voznewsStudio='ready'}
