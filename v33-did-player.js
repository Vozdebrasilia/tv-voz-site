...
@media(max-width:760px){#tv-ao-vivo{border-radius:16px!important}.vn-market-label,.vn-hot-label{padding:0 7px}.vn-market-runner span,.vn-hot-runner span{padding-right:42px}.vn-image-status{font-size:10px;padding:8px 12px}.vn-ray{height:1px}}
@media(prefers-reduced-motion:reduce){.vn-market-runner,.vn-hot-runner,.vn-lightfx::before,.vn-ray{animation:none!important}}
`;
