(() => {
  ...
  const analysts=[
    {name:'Dra. Deijanete Fayad',role:'Análise VOZ NEWS',img:'./deijanete-fayad-anchor.jpg'},
    {name:'Paulo Fayad',role:'Jornalista • Análise VOZ NEWS',img:'./paulo-fayad-anchor.jpg'}
  ];
  ...
  .v33-analyst{text-align:center;opacity:.96;transition:.25s}.v33-analyst.active{opacity:1;transform:translateY(-4px)}.v33-analyst img{width:190px;height:250px;object-fit:cover;object-position:center;display:block;margin:auto;filter:none;background:#eef4f9;border-radius:18px;box-shadow:0 10px 28px rgba(0,0,0,.18)}.v33-analyst strong{display:block;margin-top:10px;font-size:18px}.v33-analyst span{display:block;margin-top:4px;font-size:11px;color:#d4af37;font-weight:900;text-transform:uppercase;letter-spacing:.7px}
