...
.vn-lightfx::before{content:"";position:absolute;inset:-8%;background:radial-gradient(circle at 14% 3%,rgba(145,225,255,.55),transparent 8%),radial-gradient(circle at 35% 2%,rgba(255,255,255,.48),transparent 7%),radial-gradient(circle at 57% 2%,rgba(132,220,255,.50),transparent 7%),radial-gradient(circle at 79% 3%,rgba(255,255,255,.44),transparent 8%),radial-gradient(circle at 94% 6%,rgba(99,207,255,.42),transparent 7%);animation:vnPulse 3.8s ease-in-out infinite alternate}
.vn-lightfx::after{content:"";position:absolute;left:-80%;top:-12%;width:70%;height:124%;background:linear-gradient(90deg,transparent 0%,transparent 42%,rgba(105,218,255,.10) 46%,rgba(205,247,255,.70) 50%,rgba(85,189,255,.18) 54%,transparent 58%,transparent 100%);filter:blur(7px);opacity:.88;box-shadow:0 0 30px rgba(92,211,255,.18);transform:translate3d(0,0,0) skewX(-14deg);animation:vnLedSweep 5.8s linear infinite;will-change:transform}
